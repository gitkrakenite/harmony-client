                  ...
                  <div>
                    ...
                    >
                      {searchedResults?.map((item) => (
                        <div
                          key={item._id}
                          className=" mb-[20px] bg-zinc-700 text-zinc-300  p-2 rounded-lg"
                        >
                          <div>
                            <Link to={`/issue/${item._id}`}>
                              ...
                              <div className="w-full flex justify-center mb-[20px]">
                                <img
                                  src={item.photo}
                                  className="w-[180px] object-contain rounded-xl"
                                  alt=""
                                />
                              </div>

                              <div>
                                <p className="text-zinc-300 font-semibold mb-[10px] text-md">
                                ...
                                <div className=" flex flex-col gap-[10px] mb-[10px]">
                                  <div>
                                    <h2 className="mb-[5px] font-bold text-zinc-400">
                                      Directed To
                                    </h2>
                                  ...
                                  <div className="flex items-center gap-[20px] flex-wrap justify-between">
                                    <div>
                                      {!item.resolved ? (
                                        <>
                                          <div className="flex gap-[5px] items-center text-pink-400">
                                            <FaRegSadCry />
                                            <p>Not Resolved</p>
                                          </div>
                                        </>
                                    ...
                                    <div className="flex gap-[25px] items-center">
                                      <div className="flex items-center gap-[10px]">
                                        <AiOutlineComment className="text-2xl text-pink-500" />
